...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		.licenseUrl("https://github.com/pedrosantosara/blogPessoalBackend")
		.contact(contact())
		.build();
		}

	private static Contact contact() {
		return new Contact("Pedro Henrique",
		"https://github.com/pedrosantosara",
		"pedrosantosaraujo@gmail.com");
		}
